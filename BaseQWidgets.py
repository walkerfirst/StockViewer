...
from PyQt5.QtGui import QCursor, QStandardItemModel, QStandardItem, QBrush, QColor, QFont, QDesktopServices,QIcon
...
class BaseStandardTable2(QWidget,QObject):
        ...
        try:
            if not self.df.empty:
                ...
                for index in range(0,row-1):
                    ...
                    if byname == 'price':
                        self.model.item(index, column).setForeground(QBrush(QColor("orange")))
        except Exception as e:
    ...
    def setForeground_LastLine(self,value,index,column):
        ...
        try:
            ...
            print('BaseQW set single color 发生错误%s'%str(e))
